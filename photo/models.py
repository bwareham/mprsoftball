...
class Photo(models.Model):
    ...
    player_tag = models.ManyToManyField(Player, limit_choices_to={'id__in': Player.objects.filter(active='True')}, null=True, blank=True, help_text="Optional: Identify players in photo" )
